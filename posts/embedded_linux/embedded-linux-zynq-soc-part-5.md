...
2. [How the IP works](#how-the-ip-works)
3. [Step 1 - module init and exit](#step-1-module-init-and-exit)
4. [Step 2 - probe, the device tree and a misc device](#step-2-probe-the-device-tree-and-a-misc-device)
   - [4.1 platform_driver struct](#platform_driver)
   - [4.2 platform_driver_register / unregister](#platform_driver_register)
   - [4.3 of_device_id](#of_device_id)
   - [4.4 systolic_dev](#systolic_dev)
   - [4.5 systolic_probe](#systolic_probe-s2)
   - [4.6 systolic_remove](#systolic_remove-s2)
   - [4.7 Device tree overlay](#device-tree-overlay-s2)
   - [4.8 Running it on the board](#running-it-on-the-board)
5. [Step 3 - IOCTL register read and write](#step-3-ioctl-register-read-and-write)
   - [5.1 IOCTL commands](#ioctl-commands)
   - [5.2 Register offsets](#register-offsets)
   - [5.3 systolic_open and systolic_release](#systolic_open_release)
   - [5.4 systolic_ioctl](#systolic_ioctl-s3)
   - [5.5 file_operations struct](#file_operations)
   - [5.6 The userspace application](#the-userspace-application-s3)
6. [Step 4 - DMA buffers and read/write](#step-4-dma-buffers-and-the-data-path)
   - [6.1 New headers](#new-headers)
   - [6.2 systolic_dev struct](#systolic_dev-struct)
   - [6.3 systolic_set_ptr](#systolic_set_ptr)
   - [6.4 systolic_alloc_buffers](#systolic_alloc_buffers)
   - [6.5 systolic_free_buffers](#systolic_free_buffers)
   - [6.6 systolic_write](#systolic_write-s4)
   - [6.7 systolic_read](#systolic_read-s4)
   - [6.8 systolic_ioctl](#systolic_ioctl-s4)
   - [6.9 systolic_probe](#systolic_probe-s4)
   - [6.10 file_operations](#file_operations_s4)
   - [6.11 systolic_remove](#systolic_remove-s4)
   - [6.12 Device tree update](#device-tree-update)
   - [6.13 Device tree overlay](#device-tree-overlay-s4)
...
{% highlight dts linenos mark_lines="10" %}
/dts-v1/;
/plugin/;
